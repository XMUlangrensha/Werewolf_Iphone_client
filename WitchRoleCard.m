...
#import "WitchRoleCard.h"

@interface WitchRoleCard ()

@end

@implementation WitchRoleCard
@synthesize event;
@synthesize coinView;
...
- (void)viewDidLoad
{
    ...
    UIImageView *profileViewBack = [[UIImageView alloc] initWithImage:[UIImage imageNamed: @"女巫2.jpg"]];
