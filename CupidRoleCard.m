...
#import "CupidRoleCard.h"

@interface CupidRoleCard ()

@end

@implementation CupidRoleCard
@synthesize event;
@synthesize coinView;
...
- (void)viewDidLoad
{
    ...
    UIImageView *profileViewBack = [[UIImageView alloc] initWithImage:[UIImage imageNamed: @"丘比特2.jpg"]];
