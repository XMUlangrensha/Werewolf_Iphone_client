...
#import "VillagerRoleCard.h"

@interface VillagerRoleCard ()

@end

@implementation VillagerRoleCard
@synthesize event;
@synthesize coinView;
...
- (void)viewDidLoad
{
    ...
    UIImageView *profileViewBack = [[UIImageView alloc] initWithImage:[UIImage imageNamed: @"普通村民2.jpg"]];
